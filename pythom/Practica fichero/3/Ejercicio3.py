...
#         self.nombre = nombre
#         self.num_tiradas = 6
#         self.tableros = tablero(5,5)
    
#     def jugar(self):
#         fila = int(input("Ingrese fila: "))
#         columna = int(input("Ingrese columna: "))
#         if self.tableros.celda[fila][columna] == 'B':
#             print("Tocado!")
#             self.tableros.celda[fila][columna] = 'T'
#             if self.tableros.ganador():
#                 return f"¡{self.nombre} GANA!"
#         else:
#             print("Agua")
#             self.tableros.celda[fila][columna] = 'X'
#         self.num_tiradas -= 1
#         print(f"Te quedan {self.num_tiradas} tiradas")
#         return self.tableros.mostrar_tablero()